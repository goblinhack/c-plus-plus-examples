...
new MyVector(0x55bf8ab8fec0, currlen=0, maxlen=1 elems=[])
push_back called MyVector(0x55bf8ab8fec0, currlen=1, maxlen=1 elems=[10])
push_back called MyVector(0x55bf8ab8fec0, currlen=2, maxlen=2 elems=[10,11])
vec1: [10][11]

[31;1;4mCreate a new copy of vec1, vec2 via copy constructor (&):[0m
copy constructor called for MyVector(0x55bf8ab8fec0, currlen=2, maxlen=2 elems=[10,11])
copy constructor result is  MyVector(0x7ffc04143010, currlen=2, maxlen=2 elems=[10,11])
vec2: [10][11]

[31;1;4mCheck we can append onto the copied vector:[0m
push_back called MyVector(0x7ffc04143010, currlen=3, maxlen=4 elems=[10,11,12])
push_back called MyVector(0x7ffc04143010, currlen=4, maxlen=4 elems=[10,11,12,13])
vec2: [10][11][12][13]

[31;1;4mCreate a new vector from vec1, vec3 via the move constructor (&&):[0m
std::move called for MyVector(0x55bf8ab8fec0, currlen=2, maxlen=2 elems=[10,11])
std::move result is  MyVector(0x7ffc04143030, currlen=2, maxlen=2 elems=[10,11])
vec3: [10][11]

[31;1;4mCheck we can append onto the std:move'd vector:[0m
push_back called MyVector(0x7ffc04143030, currlen=3, maxlen=4 elems=[10,11,14])
push_back called MyVector(0x7ffc04143030, currlen=4, maxlen=4 elems=[10,11,14,15])
vec3: [10][11][14][15]

[31;1;4mDestroy the old vector, vec1. It has no invalid elems:[0m
delete MyVector(0x55bf8ab8fec0, currlen=0, maxlen=0 elems=[])

[31;1;4mEnd, expect vec2 and vec3 destroy:[0m
delete MyVector(0x7ffc04143030, currlen=4, maxlen=4 elems=[10,11,14,15])
delete MyVector(0x7ffc04143010, currlen=4, maxlen=4 elems=[10,11,12,13])
</pre>
