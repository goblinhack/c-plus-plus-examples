...
# Assign this initializer_list to a vector:
push_back called MyVector(0x7ffeea1a65f0, currlen=1, maxlen=1 elems=[elem1])
push_back called MyVector(0x7ffeea1a65f0, currlen=2, maxlen=2 elems=[elem1,elem2])
...
# End:
delete MyVector(0x7ffeea1a65f0, currlen=2, maxlen=2 elems=[elem1,elem2])
</pre>
