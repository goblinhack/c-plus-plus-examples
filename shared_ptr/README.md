...
Expected output:
<pre>
new Foo(0x7fb9b84029c8, data=foo1-data)
new Foo(0x7fb9b8402a38, data=foo2-data)
delete Foo(0x7fb9b8402a38, data=foo2-data)
delete Foo(0x7fb9b84029c8, data=foo1-data)
</pre>
