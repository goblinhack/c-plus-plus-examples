...
# create account1 and try to deposit into it
new cash BankAccount(0x7ffeed300680, cash $0)
deposit cash called BankAccount(0x7ffeed300680, cash $100)
BankAccount(0x7ffeed300680, cash $100)
# SUCCESS: account1 deposit succeeded!
delete account BankAccount(0x7ffeed300680, cash $100)

# create locked account2 and try to deposit into it; this should fail
new cash BankAccount(0x7ffeed300640, cash $0)
delete account BankAccount(0x7ffeed300640, cash $0)
# FAILED: account2 deposit failed!: tried to write to a locked (const) account

# create locked account3 and try to deposit into it; this should fail
new cash BankAccount(0x7ffeed300600, cash $0)
delete account BankAccount(0x7ffeed300600, cash $0)
