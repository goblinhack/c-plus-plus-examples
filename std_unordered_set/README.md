...
# Create a std::unordered_set of BankCustomer -> Account
new cash BankAccount(0x7ffee5d4e3b8, cash $100)
copy cash constructor called for BankAccount(0x7ffee5d4e3b8, cash $100)
copy cash constructor result is  BankAccount(0x7ffee5d4e3f8, cash $100)
new customer Customer(Arthur, BankAccount(0x7ffee5d4e3f8, cash $100))
copy cash constructor called for BankAccount(0x7ffee5d4e3f8, cash $100)
copy cash constructor result is  BankAccount(0x7fe279c029d8, cash $100)
delete customer Customer(Arthur, BankAccount(0x7ffee5d4e3f8, cash $100))
delete account BankAccount(0x7ffee5d4e3f8, cash $100)
delete account BankAccount(0x7ffee5d4e3b8, cash $100)
new cash BankAccount(0x7ffee5d4e368, cash $100000)
copy cash constructor called for BankAccount(0x7ffee5d4e368, cash $100000)
copy cash constructor result is  BankAccount(0x7ffee5d4e3a0, cash $100000)
new customer Customer(Zaphod, BankAccount(0x7ffee5d4e3a0, cash $100000))
copy cash constructor called for BankAccount(0x7ffee5d4e3a0, cash $100000)
copy cash constructor result is  BankAccount(0x7fe279c02a18, cash $100000)
delete customer Customer(Zaphod, BankAccount(0x7ffee5d4e3a0, cash $100000))
delete account BankAccount(0x7ffee5d4e3a0, cash $100000)
delete account BankAccount(0x7ffee5d4e368, cash $100000)
new cash BankAccount(0x7ffee5d4e308, cash $999999)
copy cash constructor called for BankAccount(0x7ffee5d4e308, cash $999999)
copy cash constructor result is  BankAccount(0x7ffee5d4e340, cash $999999)
new customer Customer(Zaphod, BankAccount(0x7ffee5d4e340, cash $999999))
delete customer Customer(Zaphod, BankAccount(0x7ffee5d4e340, cash $999999))
delete account BankAccount(0x7ffee5d4e340, cash $999999)
delete account BankAccount(0x7ffee5d4e308, cash $999999)

# Someone (Zaphod, let's face it) tried to add a 2nd account!
new cash BankAccount(0x7ffee5d4e2c8, cash $0)
copy cash constructor called for BankAccount(0x7ffee5d4e2c8, cash $0)
copy cash constructor result is  BankAccount(0x7ffee5d4e300, cash $0)
new customer Customer(Marvin, BankAccount(0x7ffee5d4e300, cash $0))
copy cash constructor called for BankAccount(0x7ffee5d4e300, cash $0)
copy cash constructor result is  BankAccount(0x7fe279c02a88, cash $0)
delete customer Customer(Marvin, BankAccount(0x7ffee5d4e300, cash $0))
delete account BankAccount(0x7ffee5d4e300, cash $0)
delete account BankAccount(0x7ffee5d4e2c8, cash $0)
new cash BankAccount(0x7ffee5d4e278, cash $666)
copy cash constructor called for BankAccount(0x7ffee5d4e278, cash $666)
copy cash constructor result is  BankAccount(0x7ffee5d4e2b0, cash $666)
new customer Customer(TheMice, BankAccount(0x7ffee5d4e2b0, cash $666))
copy cash constructor called for BankAccount(0x7ffee5d4e2b0, cash $666)
copy cash constructor result is  BankAccount(0x7fe279c02a48, cash $666)
delete customer Customer(TheMice, BankAccount(0x7ffee5d4e2b0, cash $666))
delete account BankAccount(0x7ffee5d4e2b0, cash $666)
delete account BankAccount(0x7ffee5d4e278, cash $666)
new cash BankAccount(0x7ffee5d4e228, cash $10)
copy cash constructor called for BankAccount(0x7ffee5d4e228, cash $10)
