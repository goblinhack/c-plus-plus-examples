...
# Cpp strdup wrapper with lambda deleter
copy hello addr 0x7f93ab600000
hello

# Cpp strdup wrapper with std::function deleter
copy there addr 0x7f93ab600010
there

# Cpp strdup wrapper with decltype(&mydeleter) deleter
copy Zaphod addr 0x7f93ab600020
Zaphod

# Cpp strdup wrapper with std::bind deleter
copy Beeblebrox addr 0x7f93ab600030
Beeblebrox

# End, expect memory to be freed
free Beeblebrox addr 0x7f93ab600030
free Zaphod addr 0x7f93ab600020
free there addr 0x7f93ab600010
free hello addr 0x7f93ab600000
</pre>
