...
# Create a std::initializer_list of MyString:
0x7ffeeae17728 MyString(std::string &&) elem1
0x7ffeeae17740 MyString(std::string &&) elem2

# Assign this initializer_list to a vector:
0x7fc532d02970 MyString(const std::string &) elem1
0x7fc532d02988 MyString(const std::string &) elem2

# Walk the vector with 'const auto i': (this will involve copies)
0x7ffeeae17068 MyString(const std::string &) elem1
elem1
0x7ffeeae17068 ~MyString() elem1
0x7ffeeae17068 MyString(const std::string &) elem2
elem2
0x7ffeeae17068 ~MyString() elem2
...
# Create another vector with an inline initializer list
0x7ffeeae176f8 MyString(std::string &&) elem3
0x7ffeeae17710 MyString(std::string &&) elem4
0x7fc532d029a0 MyString(const std::string &) elem3
0x7fc532d029b8 MyString(const std::string &) elem4
0x7ffeeae17710 ~MyString() elem4
0x7ffeeae176f8 ~MyString() elem3

# End:
0x7fc532d029b8 ~MyString() elem4
0x7fc532d029a0 ~MyString() elem3
0x7fc532d02988 ~MyString() elem2
0x7fc532d02970 ~MyString() elem1
0x7ffeeae17740 ~MyString() elem2
0x7ffeeae17728 ~MyString() elem1
</pre>
