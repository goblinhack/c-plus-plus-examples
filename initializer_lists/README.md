...
# Create a std::initializer_list of MyString:
0x7ffee461a838 MyString(std::string &&) elem1
0x7ffee461a850 MyString(std::string &&) elem2

# Assign this initializer_list to a vector:
0x7fb2c7d04080 MyString(const std::string &) elem1
0x7fb2c7d04098 MyString(const std::string &) elem2
...
# Create another vector with an inline initializer list
0x7ffee461a808 MyString(std::string &&) elem3
0x7ffee461a820 MyString(std::string &&) elem4
0x7fb2c7e04080 MyString(const std::string &) elem3
0x7fb2c7e04098 MyString(const std::string &) elem4
0x7ffee461a820 ~MyString() elem4
0x7ffee461a808 ~MyString() elem3

# End:
0x7fb2c7e04098 ~MyString() elem4
0x7fb2c7e04080 ~MyString() elem3
0x7fb2c7d04098 ~MyString() elem2
0x7fb2c7d04080 ~MyString() elem1
0x7ffee461a850 ~MyString() elem2
0x7ffee461a838 ~MyString() elem1
</pre>
