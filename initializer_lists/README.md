...
# Create a std::initializer_list of MyString:
0x7ffee89c4728 MyString(std::string &&) elem1
0x7ffee89c4740 MyString(std::string &&) elem2

# Assign this initializer_list to a vector:
0x7fc07c600000 MyString(const std::string &) elem1
0x7fc07c600018 MyString(const std::string &) elem2

# Walk the vector with 'const auto i': (this will involve copies)
0x7ffee89c4068 MyString(const std::string &) elem1
elem1
0x7ffee89c4068 ~MyString() elem1
0x7ffee89c4068 MyString(const std::string &) elem2
elem2
0x7ffee89c4068 ~MyString() elem2
...
# Create another vector with an inline initializer list
0x7ffee89c46f8 MyString(std::string &&) elem3
0x7ffee89c4710 MyString(std::string &&) elem4
0x7fc07c600030 MyString(const std::string &) elem3
0x7fc07c600048 MyString(const std::string &) elem4
0x7ffee89c4710 ~MyString() elem4
0x7ffee89c46f8 ~MyString() elem3

# End:
0x7fc07c600048 ~MyString() elem4
0x7fc07c600030 ~MyString() elem3
0x7fc07c600018 ~MyString() elem2
0x7fc07c600000 ~MyString() elem1
0x7ffee89c4740 ~MyString() elem2
0x7ffee89c4728 ~MyString() elem1
</pre>
