...
# Create a std::initializer_list of MyString:
0x7ffee3d6e728 MyString(std::string &&) elem1
0x7ffee3d6e740 MyString(std::string &&) elem2

# Assign this initializer_list to a vector:
0x7f82b9c020f0 MyString(const std::string &) elem1
0x7f82b9c02108 MyString(const std::string &) elem2

# Walk the vector with 'const auto i': (this will involve copies)
0x7ffee3d6e068 MyString(const std::string &) elem1
elem1
0x7ffee3d6e068 ~MyString() elem1
0x7ffee3d6e068 MyString(const std::string &) elem2
elem2
0x7ffee3d6e068 ~MyString() elem2
...
# Create another vector with an inline initializer list
0x7ffee3d6e6f8 MyString(std::string &&) elem3
0x7ffee3d6e710 MyString(std::string &&) elem4
0x7f82b9c02120 MyString(const std::string &) elem3
0x7f82b9c02138 MyString(const std::string &) elem4
0x7ffee3d6e710 ~MyString() elem4
0x7ffee3d6e6f8 ~MyString() elem3

# End:
0x7f82b9c02138 ~MyString() elem4
0x7f82b9c02120 ~MyString() elem3
0x7f82b9c02108 ~MyString() elem2
0x7f82b9c020f0 ~MyString() elem1
0x7ffee3d6e740 ~MyString() elem2
0x7ffee3d6e728 ~MyString() elem1
</pre>
