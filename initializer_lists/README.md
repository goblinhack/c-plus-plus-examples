...
# Create a std::initializer_list of MyString:
0x7ffee135ebf8 MyString(std::string &&) elem1
0x7ffee135ec10 MyString(std::string &&) elem2

# Assign this initializer_list to a vector:
0x7fc92bc05bc0 MyString(const std::string &) elem1
0x7fc92bc05bd8 MyString(const std::string &) elem2
...
# Create another vector with an inline initializer list
0x7ffee135ebc8 MyString(std::string &&) elem3
0x7ffee135ebe0 MyString(std::string &&) elem4
0x7fc92bc05bf0 MyString(const std::string &) elem3
0x7fc92bc05c08 MyString(const std::string &) elem4
0x7ffee135ebe0 ~MyString() elem4
0x7ffee135ebc8 ~MyString() elem3

# End:
0x7fc92bc05c08 ~MyString() elem4
0x7fc92bc05bf0 ~MyString() elem3
0x7fc92bc05bd8 ~MyString() elem2
0x7fc92bc05bc0 ~MyString() elem1
0x7ffee135ec10 ~MyString() elem2
0x7ffee135ebf8 ~MyString() elem1
</pre>
