...
# Assign this initializer_list to a vector:
0x7ff7e7402990 MyString(const std::string &) elem1
0x7ff7e74029a8 MyString(const std::string &) elem2
...
0x7ff7e74029c0 MyString(const std::string &) elem3
0x7ff7e74029d8 MyString(const std::string &) elem4
0x7ffee7183710 ~MyString() elem4
0x7ffee71836f8 ~MyString() elem3

# End:
0x7ff7e74029d8 ~MyString() elem4
0x7ff7e74029c0 ~MyString() elem3
0x7ff7e74029a8 ~MyString() elem2
0x7ff7e7402990 ~MyString() elem1
