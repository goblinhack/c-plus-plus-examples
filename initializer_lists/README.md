...
# Create a std::initializer_list of MyString:
0x7ffee46df838 MyString(std::string &&) elem1
0x7ffee46df850 MyString(std::string &&) elem2

# Assign this initializer_list to a vector:
0x7f86de405b90 MyString(const std::string &) elem1
0x7f86de405ba8 MyString(const std::string &) elem2
...
# Create another vector with an inline initializer list
0x7ffee46df808 MyString(std::string &&) elem3
0x7ffee46df820 MyString(std::string &&) elem4
0x7f86de405bc0 MyString(const std::string &) elem3
0x7f86de405bd8 MyString(const std::string &) elem4
0x7ffee46df820 ~MyString() elem4
0x7ffee46df808 ~MyString() elem3

# End:
0x7f86de405bd8 ~MyString() elem4
0x7f86de405bc0 ~MyString() elem3
0x7f86de405ba8 ~MyString() elem2
0x7f86de405b90 ~MyString() elem1
0x7ffee46df850 ~MyString() elem2
0x7ffee46df838 ~MyString() elem1
</pre>
