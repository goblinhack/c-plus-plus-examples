...
# Create some accounts
new cash BankAccount(0x7ffee9d55fc0, cash $10000)
new cash BankAccount(0x7ffee9d55fb0, cash $20000)
new cash BankAccount(0x7ffee9d55fa0, cash $30000)
new cash BankAccount(0x7ffee9d55f90, cash $30000)

# Add an account with insert()
copy cash constructor called for BankAccount(0x7ffee9d55fc0, cash $10000)
copy cash constructor result is  BankAccount(0x7ffee9d55f8c, cash $10000)
copy cash constructor called for BankAccount(0x7ffee9d55f8c, cash $10000)
copy cash constructor result is  BankAccount(0x7fc4d04029b0, cash $10000)
delete account BankAccount(0x7ffee9d55f8c, cash $10000)

# Add an account with map[k] = v
default constructor BankAccount(0x7fc4d04029e0, cash $0)

# Add an account with emplace()
copy cash constructor called for BankAccount(0x7ffee9d55fa0, cash $30000)
copy cash constructor result is  BankAccount(0x7ffee9d55f74, cash $30000)
copy cash constructor called for BankAccount(0x7ffee9d55f74, cash $30000)
copy cash constructor result is  BankAccount(0x7fc4d0402a10, cash $30000)
delete account BankAccount(0x7ffee9d55f74, cash $30000)
...
# Remove account2
delete account BankAccount(0x7fc4d04029e0, cash $20000)
...
# Modify account3
deposit cash called BankAccount(0x7fc4d0402a10, cash $30100)
...
# Rob the bank
delete account BankAccount(0x7fc4d04029b0, cash $10000)
delete account BankAccount(0x7fc4d0402a10, cash $30100)

# End
delete account BankAccount(0x7ffee9d55f90, cash $30000)
delete account BankAccount(0x7ffee9d55fa0, cash $30000)
delete account BankAccount(0x7ffee9d55fb0, cash $20000)
delete account BankAccount(0x7ffee9d55fc0, cash $10000)
</pre>
