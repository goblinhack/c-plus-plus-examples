...
# create account1 and try to deposit into it
new cash BankAccount(0x7ffeea56af28, cash $0)

# invoke a bind to a method via proxy
copy cash constructor called for BankAccount(0x7ffeea56af28, cash $0)
copy cash constructor result is  BankAccount(0x7ffeea56af20, cash $0)
deposit cash called BankAccount(0x7ffeea56af20, cash $100)

# invoke a bind to a method via proxy with std::ref
deposit cash called BankAccount(0x7ffeea56af28, cash $100)

# invoke a bind to a method directly
deposit cash called BankAccount(0x7ffeea56af28, cash $200)

# check the deposits succeeded
delete account BankAccount(0x7ffeea56af20, cash $100)
delete account BankAccount(0x7ffeea56af28, cash $200)
# FAILED: account1 deposit failed!: account has different funds BankAccount(0x7ffeea56af28, cash $200) than expected 300
</pre>
