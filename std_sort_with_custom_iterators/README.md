...
push_back called MyVector(0x7ffc26f77c90, len=1, maxlen=1 elems=[zaphod])
push_back called MyVector(0x7ffc26f77c90, len=2, maxlen=2 elems=[zaphod,universe])
push_back called MyVector(0x7ffc26f77c90, len=3, maxlen=4 elems=[zaphod,universe,arthur])
push_back called MyVector(0x7ffc26f77c90, len=4, maxlen=4 elems=[zaphod,universe,arthur,marvin])
push_back called MyVector(0x7ffc26f77c90, len=5, maxlen=8 elems=[zaphod,universe,arthur,marvin,mice])
push_back called MyVector(0x7ffc26f77c90, len=6, maxlen=8 elems=[zaphod,universe,arthur,marvin,mice,vogon])
...
[31;1;4mEnd:[0m
delete MyVector(0x7ffc26f77c90, len=6, maxlen=8 elems=[,,,,,arthur])
</pre>
