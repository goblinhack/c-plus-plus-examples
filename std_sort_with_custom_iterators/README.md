...
# Assign this initializer_list to a vector:
push_back called MyVector(0x7ffeec629780, len=1, maxlen=1 elems=[zaphod])
push_back called MyVector(0x7ffeec629780, len=2, maxlen=2 elems=[zaphod,universe])
push_back called MyVector(0x7ffeec629780, len=3, maxlen=4 elems=[zaphod,universe,arthur])
push_back called MyVector(0x7ffeec629780, len=4, maxlen=4 elems=[zaphod,universe,arthur,marvin])
push_back called MyVector(0x7ffeec629780, len=5, maxlen=8 elems=[zaphod,universe,arthur,marvin,mice])
push_back called MyVector(0x7ffeec629780, len=6, maxlen=8 elems=[zaphod,universe,arthur,marvin,mice,vogon])
...
# End:
delete MyVector(0x7ffeec629780, len=6, maxlen=8 elems=[zaphod,vogon,universe,mice,marvin,arthur])
</pre>
