...
# Create a custom vector class:
new MyVector(0x7ffee88f16f0, currlen=0, maxlen=1 elems=[])
push_back called MyVector(0x7ffee88f16f0, currlen=1, maxlen=1 elems=[10])
push_back called MyVector(0x7ffee88f16f0, currlen=2, maxlen=2 elems=[10,11])
push_back called MyVector(0x7ffee88f16f0, currlen=3, maxlen=4 elems=[10,11,12])
...
# End, expect vec1 destroy:
delete MyVector(0x7ffee88f16f0, currlen=3, maxlen=4 elems=[10,11,12])
</pre>
