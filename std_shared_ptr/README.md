...
# Create a copy constructed class and share it between two pointers:
new Foo(0x7ffee2131c50, data=foo1)
copy constructor Foo(0x7fe700c05be8, data=)
delete Foo(0x7ffee2131c50, data=foo1)
...
delete Foo(0x7fe700c05be8, data=foo1)
sptr2 ref count now 0

# You can also create shared pointers WITHOUT copy constructor overhead
new Foo(0x7fe700c05ba0, data=foo0)
sptr0 = Foo(0x7fe700c05ba0, data=foo0)
delete Foo(0x7fe700c05ba0, data=foo0)
</pre>
