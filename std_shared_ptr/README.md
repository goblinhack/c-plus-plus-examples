...
# Create a copy constructed class and share it between two pointers:
new Foo(0x7ffee1750220, data=foo1)
copy constructor Foo(0x7fdd9ed000c8, data=)
delete Foo(0x7ffee1750220, data=foo1)
...
delete Foo(0x7fdd9ed000c8, data=foo1)
sptr2 ref count now 0

# You can also create shared pointers WITHOUT copy constructor overhead
new Foo(0x7fdd9ed00080, data=foo0)
sptr0 = Foo(0x7fdd9ed00080, data=foo0)
delete Foo(0x7fdd9ed00080, data=foo0)
</pre>
